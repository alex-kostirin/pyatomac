...
from AppKit import (NSApp, NSApplicationMain,
...
class PyObjCAppHelperCaller_wrap(NSObject):
...
class PyObjCAppHelperApplicationActivator_wrap(NSObject):
    def activateNow_(self, aNotification):
        NSApp().activateIgnoringOtherApps_(True)


class PyObjCAppHelperRunLoopStopper_wrap(NSObject):
    singletons = {}
    ...
    def init(self):
        self = super(PyObjCAppHelperRunLoopStopper_wrap, self).init()
